...
class TestCases(TestCase):
    def setUp(self):
        ...
        PadUsed.objects.create(rocket=Rocket.objects.get(name="Falcon 9"), pad=Pad.objects.get(name="Space Launch Complex 40"))
        PadUsed.objects.create(rocket=Rocket.objects.get(name="Falcon Heavy"), pad=Pad.objects.get(name="Launch Complex 39A"))
        PadUsed.objects.create(rocket=Rocket.objects.get(name="Falcon 9"), pad=Pad.objects.get(name="Launch Complex 39A"))
