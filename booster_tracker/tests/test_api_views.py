...
class HomeDataApiViewTests(APITestCase):
    ...
    def test_with_launches(self):
        ...
        self.assertEqual(data["turnaround_x_values"], [0.0, 0.5, 1.0, 1.5, 2.0, 2.5, 3.0])
        self.assertEqual(data["turnaround_data"], [None, 31.0, None, 29.0, None, 31.0, None])
        np.testing.assert_array_almost_equal(
            data["best_fit_turnaround_values"], [30.42, 30.42, 30.42, 30.42, 30.42, 30.42, 30.42], decimal=0
        )
